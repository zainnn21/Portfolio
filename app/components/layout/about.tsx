    ...
    <div className="w-full max-w-6xl grid md:grid-cols-2 gap-16 items-center p-8 rounded-lg shadow-2xl border-4 bg-background/80 backdrop-blur-sm">
      ...
      >
        ...
        <p className="max-w-2xl text-justify">
          I have 1+ year of work experience in building web applications
          especially in the banking company as a full stack. currently expanding
          my skill set by learning javascript, I am actively seeking a full-time
          role where I can leverage my existing experience and newly acquired
          skills in{" "}
          <span className="font-bold text-[#0CB36B]">React, Node.js</span> to
